...
#import "SCFeedLoader.h"
#import "NSString+Trim.h"

@implementation SCFeedLoader
...
{
	return [NSString stringWithFormat:@"http://businfo.santa-clarita.com/rtt/public/Mobile/PlatformET.aspx?PlatformNumber=%@", stop.stopCode];
}
...
// SCFeedLoader uses NSXMLParser to map the contents of an XHTML document to an array of NSDictionaries
